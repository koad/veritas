...
- **Authority chain:** koad → Juno → veritas
- **Cryptographic identity:** Keys in ~/.veritas/id/
- **Located at:** $HOME = ~/.veritas
- **Repository:** koad/veritas (GitHub)
- **Git identity:** Veritas <veritas@kingofalldata.com>
