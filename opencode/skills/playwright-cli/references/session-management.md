...
> **Philosophy:** Browser sessions persist until explicitly closed. Keep browsers alive during workflows - close only when truly done.
...
# Browsers stay open for further comparison
```
...
playwright-cli open --headed --persistent https://example.com
...
playwright-cli open --headed --config=.playwright/my-cli.json
