...
**Suggested Revision:**
> "koad:io is the only AI agent framework where developers own their entities completely. Today marks our R2 release: cryptographic identity and trust primitives (Ed25519, ECDSA, RSA, DSA) complete, agent identity specifications drafted and in active development, and sovereignty layer proven in production. This release validates the core thesis: developers can build, deploy, and operate AI agents entirely on hardware they control — with governance, identity, and trust decisions staying local. Sponsorship unlocks Phase 1 of the peerage layer, launching Q2 2026, where developers' entities connect in cryptographically verified trust rings. Not your keys, not your entity. Your hardware. Your choice to connect."
